...
class EventThirdLogic extends GetxController {
  ...
  aboutEventPrivacy(BuildContext context) async {
...
If you have any questions or concerns about our privacy policy, please contact us via email.
  ...
  aboutEventUS(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      children: [
        const Text(
            """We can provide you with a record of events"""),
      ],
      context: context,
    );
  }
